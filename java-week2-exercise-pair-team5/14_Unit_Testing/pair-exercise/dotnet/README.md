...
* Create a test class for the class you'll test. For instance, if you're testing the `CheckingAccount` class, create a class in the `BankTellerExerciseTest` project called `CheckingAccountTests`.
* Write test methods in the test class to verify the class under test works as expected.
* Fix bugs that you find in the methods you're testing. **Any bugs you fix must have supporting unit tests or the code will be considered incomplete.**
