...
<body>
	...
	<section>
		<h2 class="centered">
		<!-- Choose F or C will bring all new page with C or F and F is set as defaul at homepage -->
...
<div class="column">
		<c:forEach items="${weatherList}" var="weather">
			<div style="display: flex">
				...
				<!-- Have to c:if for partly cloudy cause in photo name is partlyCloudy but in details is partly cloudy -->
