...
<body>
    ...
    <nav>
        ...
        <ul>
        	<c:url value="/alienAge" var="alienAgeHref"/>
        	<c:url value="/alienWeight" var="alienWeightHref"/>
        	<c:url value="/driveTime" var="driveTimeHref"/>
        	<c:url value="/forum" var="forumHref"/>
        	<c:url value="/spaceStore" var="storeHref"/>
            <li><a href="${alienAgeHref}">Alien Age</a></li>
            <li><a href="${alienWeightHref}">Alien Weight</a></li>
            <li><a href="${driveTimeHref}">Alien Travel  Time</a></li> 
            <li><a href="${forumHref}">Space Forum</a></li>
            <li><a href="${storeHref}"> Space Store </a>               
        </ul>
    </nav>